...
article_file = "C:/Benben/UD032 mongoDB/Lesson_2_Data_in_More_Complex_Formats/08-Handling_Attributes/exampleResearchArticle.xml"
...
def get_authors(root):
    ...
    for author in root.findall('./fm/bibl/aug/au'):
        ...
        for i in insr:
            data["insr"].append(i.attrib["iid"])   #attrib["iid"]
        authors.append(data)
